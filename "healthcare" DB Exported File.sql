CREATE DATABASE  IF NOT EXISTS `healthcare` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */;
USE `healthcare`;
...
CREATE TABLE `patients` (
  ...
  `pBDate` varchar(45) DEFAULT NULL,
...
-- Dump completed on 2020-05-05  0:33:55
